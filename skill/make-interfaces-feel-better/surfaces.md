...
```tsx
// Tailwind
<button className="pl-4 pr-[14px]">Continue <ChevronRight /></button>
```
...
```tsx
<button className="relative size-5 after:absolute after:inset-1/2 after:size-10 after:-translate-x-1/2 after:-translate-y-1/2" />
```
